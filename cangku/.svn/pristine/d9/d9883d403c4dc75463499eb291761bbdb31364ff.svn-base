package com.guantang.cangkuonline.swipemenuXlistview;
 ...
 * 
 */
public class SwipeMenuXLayout extends FrameLayout {
	...
	private SwipeMenuXView mMenuView;
	private int mDownX;
	...
	public SwipeMenuXLayout(View contentView, SwipeMenuXView menuView) {
	...
	private SwipeMenuXLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	private SwipeMenuXLayout(Context context) {
		super(context);
	}
	...
	public SwipeMenuXView getMenuXView() {
		return mMenuView;
	}
